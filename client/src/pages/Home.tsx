...
const INSTAGRAM_REELS = [
  { id: "DTeq83TDD80", title: "Teachers taking attendance be like..." },
  { id: "DTlLaTyjBUQ", title: "Me trying to explain the situation to a parent" },
  { id: "DWiAHq9IkAi", title: "I wish I never saw this as a teacher" },
  { id: "DVhq6snDJUv", title: "Teachers: Have you met this student?" },
  { id: "DVcgZVjjM_O", title: "Teacher survival kit" },
  { id: "DU3RITQDG6O", title: "What goes up must come down…unless it goes through the roof." },
];
...
function InstagramSection() {
  ...
  return (
    <section id="instagram-reels" className="py-20 bg-[oklch(0.12_0.03_255)]">
      <div className="container">
        <AnimatedSection>
          <div className="text-center mb-12">
            <div className="inline-block bg-[oklch(0.92_0.18_95)] text-[oklch(0.12_0.03_255)] font-bangers text-sm px-3 py-1 comic-border mb-4">
              INSTAGRAM REELS
            </div>
            <h2 className="font-bangers text-white text-5xl md:text-7xl leading-none">
              CATCH THE<br />
              <span className="text-[oklch(0.92_0.18_95)]">REELS</span>
            </h2>
          </div>
        </AnimatedSection>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {INSTAGRAM_REELS.map((reel, index) => (
            ...
            >
              <div className="comic-border-lg overflow-hidden rounded-sm bg-white relative">
                <div className="absolute top-2 left-2 z-10 bg-[oklch(0.92_0.18_95)] text-[oklch(0.12_0.03_255)] font-bangers text-sm px-2 py-0.5 comic-border">
                  #{index + 1}
                </div>
                <blockquote
                  ...
                  style={{ background: "#FFF", border: 0, margin: 0, maxWidth: "100%", minWidth: "326px", padding: 0, width: "100%" }}
                />
              </div>
            </motion.div>
          ))}
        ...
        <AnimatedSection className="text-center mt-10">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="pop-btn bg-[oklch(0.92_0.18_95)] text-[oklch(0.12_0.03_255)] px-10 py-4 rounded-sm inline-flex items-center gap-3 font-bangers text-xl"
          >
            <svg viewBox="0 0 24 24" className="w-6 h-6 fill-[oklch(0.12_0.03_255)]" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
            </svg>
